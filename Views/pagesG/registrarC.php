...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="./registrarC.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="ni ni-books text-primary text-sm opacity-10"></i>
            </div>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Registrar Categorias</h6>
        </nav>
  ...
  <center><img class="logo-form" src="../assets3/img/escoinfer/logo.png">
       <h2>REGISTRAR CATEGORIA</h2></center><br>
      <form id="frm-usuario" action="../../Models/Gerente/insertC.php" method="POST">

      <!--Ingresar nombre de la categoria-->
      <div class="form-group" id="g-categoria">
          <div class="form-group-input">
            <label for="categoria">Nombre de la categoria</label>
              <input type="text" name="categoria" id="categoria" class="frm-input">
              <i class="bi bi-check-circle-fill frm-icono"></i>                        
              <span class="msn-error">Este nombre no es valido, mínimo 5 caracteres</span>
          </div>
      </div>

          <button type="submit" onclick="registrar()" class="btn-enviar">Enviar</button>
      </form>
  </div>
  </main>
